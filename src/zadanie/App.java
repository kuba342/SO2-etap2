 ...
 * 	    Plik: App.java
 * 			  główne okienko aplikacji, w którym wyświetlane są wszystkie 
 * 			  "logi" - komunikaty od poszczególnych busów.
 * 			  W tym oknie możliwa jest zmiana natężenia ruchu oraz wyświetlane
 * 			  są numery busów w kolejce oraz bezpośrednio na moście.
 * 			
 *     Autor: Jakub Derda
 * nr albumu: 252819
 *      Data: 13.01.2021
...
public class App extends JFrame implements ActionListener {
	...
	JLabel traffic                   = new JLabel("   Natężenie ruchu:");
	JLabel onTheBridge               = new JLabel("         Na moście:");
	...
	public App(NarrowBridge bridge) {
        ...
        labelTable.put(MIN_BUS_DELAY, new JLabel("Mało"));
        labelTable.put(MAX_BUS_DELAY, new JLabel("Dużo"));
